...
// THIS HAS TO GET UPDATED WHEN THE EXPERIMENT IS DEPLOYED FROM THE PRODUCTION REPO
const repoUrl = 'https://michaelmeidenbauer.github.io/RC-RAGE_jsPsych_testing/';

const slides = get_instruction_imglist(`${repoUrl}instruction/`, 28);
...
function generate_instruction_block(imglist, takeBackAmount = take_back_amount) {
    ...
    var RAGE_instruction_page_3 = {
        type: 'instructions',
        pages: slideGroups.instructions.shoot,
        data: {
